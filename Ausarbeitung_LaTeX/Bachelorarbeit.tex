...
In diesem Teil der Arbeit werden die Messergebnisse zu den vorher definierten Metriken, in Zusammenhang mit den angegebenen Testgeräten aufgelistet. In Tabelle \ref{protokoll_android} sind die Ergebnisse der Android Version und in \ref{protokoll_ios} die der iOS Version zu sehen.
