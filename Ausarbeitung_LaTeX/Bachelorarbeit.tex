...
\begin{table}[htbp]
	...
	\resizebox{0.8\textwidth}{!}{%
		\begin{tabular}{|c|c|p{5cm}|p{5cm}|p{1cm}|}
			...
			\textbf{Cloud-Basiert}                 &                                             & Verarbeitungsprozesse werden in eine Cloud ausgelagert.                                                                                                                                                                                                                                                                          & Das Endgerät und die App benötigen eine schnelle, permanente Netzwerkverbindung.                                                                                                                       & Theoretisch                                                                                                                                         \\ \hline
