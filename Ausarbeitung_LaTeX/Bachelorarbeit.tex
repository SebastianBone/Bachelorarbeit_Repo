...
\begin{table}[htbp]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{c|c|c|c|c|c|c|c|c|}
			...
			\multicolumn{1}{|c|}{\cellcolor[HTML]{00009B}{\color[HTML]{FFFFFF} \textbf{Windows Phone}}} & CLR                                                                        & C\#, C++, Visual Basic, JavaScript, .Net                                                               & XAML files                                                             & Garbage collector                                                         & Visual Studio                                               & Windows                                                           & Homogen                                                        & Windows Phone Store                                               \\ \hline
		\end{tabular}
	}
